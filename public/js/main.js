...
//var chatSection = document.getElementById('chaT1');
for (let i = 1; i <= 10; i++) {
...
function writeNewPost(uid, username, picture, title, body) {
 ...
 /* updates['/game-posts/' + uid + '/' + newPostKey] = postData;
  updates['/gameposts/' + uid + '/' + newPostKey] = postData;*/
 // updates['/chat1/' + uid + '/' + newPostKey] = postData;
  ...
  var html =
      '<div class="post post-' + postId + ' mdl-cell mdl-cell--12-col ' +
        ...
        '<div class="mdl-card mdl-shadow--2dp">' +
          '<div class="mdl-card__title mdl-color--green-300 mdl-color-text--white">' +
          ...
          '</div>' +
          '<span class="star">' +
            '<div class="not-starred material-icons"> done </div>' +
            '<div class="starred material-icons">done_all  </div>' +
...
$(".chat1, .chat2, .chat3, .chat4, .chat5, .chat6, .chat7, .chat8, .chat9, .chat10").click(function(){
  $("#indexx").hide();
  $("#calendary").hide();
  $("#locationy").hide();
  $("#resulty").hide();
